...
class OnBoardView extends StatelessWidget {
  ...
  Container googleLoginButton(BuildContext context, OnBoardViewModel viewmodel) {
    return Container(
                padding:
                    EdgeInsets.symmetric(horizontal: 30.w, vertical: 10.h),
                width: context.width,
                ...
                child: ElevatedButton(
                    style: ElevatedButton.styleFrom(
                        backgroundColor: AppThemeLight
                            .instance.theme.colorScheme.inversePrimary,
                        elevation: 3,
                        shape: RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(20))),
  ...
  Container facebookLoginButton(BuildContext context, OnBoardViewModel viewmodel) {
    return Container(
                padding:
                    EdgeInsets.symmetric(horizontal: 30.w, vertical: 10.h),
                width: context.width,
                ...
                child: ElevatedButton(
                    style: ElevatedButton.styleFrom(
                        backgroundColor: AppThemeLight
                            .instance.theme.colorScheme.inverseSurface,
                        elevation: 3,
                        shape: RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(20))),
    ...
    return Container(
              ...
              decoration: BoxDecoration(
                  image: DecorationImage(
                      image: AssetImage("asset/image/onboard.png"))),
            );
  }
}
